...
- 說明（0~40分）：說明必須開門見山，直接點出影片的核心主題、方法與結論，而非用懸念或誘導語氣吸引點擊。評分重點：(1)前兩句是否直接說明影片在講什麼、解決什麼問題 (2)是否具體呈現關鍵資訊、做法或結論，讓不看影片也能掌握實質內容 (3)嚴格扣分：「精彩內容」「乾貨滿滿」「一起來了解」「不容錯過」等空洞引導語，或僅描述活動流程而不提供實質資訊。搜尋引擎與 AI 助理無法觀看影片，說明文字是它們理解內容的唯一依據。
